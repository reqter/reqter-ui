  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <ul>
          <li>
            <button onClick={() => this.rotateToRight()}>Rotate Right</button>
          </li>
          <li>
            <button onClick={() => this.rotateToLeft()}>Rotate Left</button>
          </li>
          <li>
            <button onClick={() => this.crop(this.props, this.saveImage)}>
              Save
            </button>
          </li>
        </ul> */}
